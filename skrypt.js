...
{   document.getElementById('pbu').innerHTML=document.getElementById('ibu').value;
    ...
    document.getElementById('prac').innerHTML+='<input id ="employee" list="workers"/><datalist id="workers"><option value="Andrzejewski Artur"/><option value="Bajor Paweł"/><option value="Bober Rajmund"/><option value="Bujak Dariusz"/><option value="Cholewiński Przemysław"/><option value="Dychała Grzegorz"/><option value="Frąk Jakub"/><option value="Gronostaj Tomasz"/><option value="Gryz Marcin"/><option value="Janus Marek"/><option value="Jęczara Marcin"/><option value="Kraska Paweł"/><option value="Kubicki Paweł"/><option value="Latała Zbigniew"/><option value="Lucjan Popiel"/><option value="Łebek Bogusław"/><option value="Majtyka Krzysztof"/><option value="Mazurczak Grzegorz"/><option value="Pokój Mariusz"/><option value="Radomski Leszek"/><option value="Rybiński Jacek"/><option value="Sowa Marek"/><option value="Stępnik Andrzej"/><option value="Wiśniewski Sylwester"/></datalist>';
